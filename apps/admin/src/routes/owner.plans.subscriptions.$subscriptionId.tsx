...
import Page from "../../pages/owner/plans/subscriptions/[subscriptionId]/page";
...
const loadPageData = createServerFn({ method: "GET", strict: false })
  ...
  .handler(async ({ data }) => {
    const { loadPage } = await import("../../pages/owner/plans/subscriptions/[subscriptionId]/page.server");
    return runAdminPageLoader(() => loadPage(data));
  });

export const Route = createFileRoute("/owner/plans/subscriptions/$subscriptionId")({
