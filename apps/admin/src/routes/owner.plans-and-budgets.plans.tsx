...
import Page from "../../pages/owner/plans-and-budgets/plans/page";
...
const loadPageData = createServerFn({ method: "GET", strict: false })
  ...
  .handler(async ({ data }) => {
    const { loadPage } = await import("../../pages/owner/plans-and-budgets/plans/page.server");
    return runAdminPageLoader(() => loadPage(data));
  });

export const Route = createFileRoute("/owner/plans-and-budgets/plans")({
