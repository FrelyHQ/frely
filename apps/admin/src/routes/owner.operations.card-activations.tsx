...
import Page from "../../pages/owner/operations/card-activations/page";
...
const loadPageData = createServerFn({ method: "GET", strict: false })
  ...
  .handler(async ({ data }) => {
    const { loadPage } = await import("../../pages/owner/operations/card-activations/page.server");
    return runAdminPageLoader(() => loadPage(data));
  });

export const Route = createFileRoute("/owner/operations/card-activations")({
