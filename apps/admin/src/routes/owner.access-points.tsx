...
import Page from "../../pages/owner/access-points/page";
...
const loadPageData = createServerFn({ method: "GET", strict: false })
  ...
  .handler(async ({ data }) => {
    const { loadPage } = await import("../../pages/owner/access-points/page.server");
    return runAdminPageLoader(() => loadPage(data));
  });

export const Route = createFileRoute("/owner/access-points")({
