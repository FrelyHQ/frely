...
export async function changeOwnerPassword(input: PasswordChangeInput): Promise<PasswordChangeResult> {
  const response = await fetch("/api/owner/security/password", {
    method: "POST",
